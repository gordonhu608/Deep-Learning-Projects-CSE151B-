...
from arch2_model_factory import get_model
...
class Experiment(object):
    def __init__(self, name):
        ...
        self.__val_losses = []
        self.__best_model = None  # Save your b dvest model in this field and use this in test method.
        ...
        #self.__encoder_optimizer = optim.Adam(params=filter(lambda p: p.requires_grad, self.__encoder.parameters()),
        #                                    lr=self.__lr)
        ...
        with torch.no_grad():
            for iter, (orig_image, images, captions, img_ids, lengths) in enumerate(self.__test_loader):
                ...
                for ref in reference:
                    bleu_ref.append(nltk.tokenize.word_tokenize(ref.lower()))
